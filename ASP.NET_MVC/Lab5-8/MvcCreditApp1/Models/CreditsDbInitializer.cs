...
namespace MvcCreditApp1.Models
{
    public class CreditsDbInitializer : DropCreateDatabaseIfModelChanges<CreditContext>
    {
        ...
        {
            context.Credits.Add(new Credit { Head = "Ипотечный кредит", Period = 15, Sum = 1000000, Procent = 15 });
            context.Credits.Add(new Credit { Head = "Образовательный кредит", Period = 10, Sum = 300000, Procent = 10 });
